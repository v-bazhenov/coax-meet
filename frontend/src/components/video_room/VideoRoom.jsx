                    ...
                    <>
                        ...
                        <div className={classes.videoGrid}>
                            {peersEstablished.length > 0 ? (
                                ...
                                <Alert severity="info">{t('Nobody joined yet!')}</Alert>
                            )}
                        </div>
                    </>
                ) : (
...
export default withStyles(videoRoomStyles)(withTranslation()(VideoRoom));
